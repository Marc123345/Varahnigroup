  ...
  return (
    <SectionWrapper dark>
      <div className="max-w-7xl mx-auto">
        ...
        <p className="typo-meta tracking-[0.25em] uppercase font-inter mb-2" style={{ color: 'rgba(255,255,255,0.72)' }}>COMPANIES</p>
          ...
          {companies.map((company) => (
            ...
            >
              ...
              <div className="md:col-span-2 p-6 md:p-8 flex flex-col justify-center" style={{ background: 'rgba(255,255,255,0.03)' }}>
                ...
                <p className="typo-copy-small font-inter text-white/85 mb-4">
                  {company.description}
                </p>
