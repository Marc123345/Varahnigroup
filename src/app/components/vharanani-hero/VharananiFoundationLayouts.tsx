    ...
    <div>
      ...
      <div className="relative h-[55vh] min-h-[440px] overflow-hidden">
        ...
        <div className="absolute inset-0" style={{
          background: 'linear-gradient(180deg, rgba(44,45,45,0.3) 0%, rgba(137,43,28,0.2) 40%, rgba(44,45,45,0.85) 100%)'
        }} />
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-16 md:py-24">
          ...
          >
            ...
            <div className="lg:col-span-5 relative min-h-[380px]">
              ...
              />
              <div className="absolute inset-0" style={{
                background: 'linear-gradient(180deg, rgba(44,45,45,0.1) 0%, rgba(44,45,45,0.3) 50%, rgba(44,45,45,0.85) 100%)'
              }} />
  ...
  return (
    <SectionWrapper className="!py-0 !px-0">
      ...
      <div className="relative h-[32vh] min-h-[260px] overflow-hidden">
        ...
        />
        <div className="absolute inset-0" style={{
          background: 'linear-gradient(180deg, rgba(137,43,28,0.5) 0%, rgba(44,45,45,0.85) 100%)'
        }} />
        <div className="absolute bottom-0 left-0 right-0 h-[3px]" style={{ background: 'var(--vharanani-burgundy)' }} />
          ...
          <div className="overflow-hidden" style={{ border: '1px solid var(--vharanani-charcoal-20)', borderTop: 'none' }}>
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
              ...
              <div className="lg:col-span-5 relative h-[320px] lg:h-auto lg:min-h-[440px]">
                ...
                />
                <div className="absolute inset-0" style={{
                  background: 'linear-gradient(180deg, rgba(44,45,45,0.1) 0%, rgba(44,45,45,0.4) 50%, rgba(44,45,45,0.9) 100%)'
                }} />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-16 md:py-24">
        ...
        >
          ...
          <div className="lg:col-span-5 relative min-h-[360px]">
            ...
            />
            <div className="absolute inset-0" style={{
              background: 'linear-gradient(180deg, rgba(137,43,28,0.2) 0%, rgba(44,45,45,0.5) 100%)'
            }} />
            {/* Overlaid quote */}
    ...
    <div>
      <div className="overflow-hidden">
        ...
        <div className="relative h-[28vh] min-h-[220px] overflow-hidden">
          ...
          />
          <div className="absolute inset-0" style={{
            background: 'linear-gradient(180deg, rgba(137,43,28,0.6) 0%, rgba(44,45,45,0.9) 100%)'
          }} />
          <div className="absolute inset-0 flex flex-col justify-end px-6 md:px-12 lg:px-20 pb-10">
            <div className="max-w-7xl mx-auto w-full">
              <div className="flex items-center gap-3 mb-4">
