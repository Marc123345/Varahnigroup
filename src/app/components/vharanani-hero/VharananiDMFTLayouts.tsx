        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-10 md:py-16">
          ...
          >
            ...
            <div className="lg:col-span-5 relative min-h-[380px]">
              ...
              />
              <div className="absolute inset-0" style={{
                background: 'linear-gradient(180deg, rgba(129,41,33,0.05) 0%, rgba(129,41,33,0.3) 60%, rgba(129,41,33,0.8) 100%)'
              }} />
              {/* Overlaid badge */}
              <div className="absolute bottom-0 left-0 right-0 p-6" style={{ background: 'rgba(129,41,33,0.85)', backdropFilter: 'blur(8px)' }}>
                <div className="flex items-center gap-3">
  ...
  return (
    <SectionWrapper className="!py-0 !px-0">
      ...
      <div className="relative h-[35vh] sm:h-[40vh] min-h-[260px] sm:min-h-[320px] overflow-hidden">
        ...
        />
        <div className="absolute inset-0" style={{
          background: 'linear-gradient(180deg, rgba(129,41,33,0.5) 0%, rgba(129,41,33,0.7) 50%, rgba(129,41,33,0.98) 100%)'
        }} />
        <div className="absolute bottom-0 left-0 right-0 h-[3px]" style={{ background: 'var(--vharanani-burgundy)' }} />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="lg:col-span-7 relative h-[320px] lg:h-auto lg:min-h-[440px] overflow-hidden group">
              ...
              />
              <div className="absolute inset-0" style={{
                background: 'linear-gradient(135deg, rgba(129,41,33,0.3) 0%, rgba(129,41,33,0.5) 100%)'
              }} />
              {/* Ghost number */}
              ...
              {/* Bottom metric */}
              <div className="absolute bottom-0 left-0 right-0 px-8 py-5" style={{ background: 'rgba(129,41,33,0.85)', backdropFilter: 'blur(8px)' }}>
                <div className="flex items-center gap-4">
              ...
              return (
                ...
                >
                  ...
                  <div className="relative h-[220px] overflow-hidden">
                    ...
                    />
                    <div className="absolute inset-0" style={{
                      background: 'linear-gradient(180deg, rgba(129,41,33,0.1) 0%, rgba(129,41,33,0.6) 100%)'
                    }} />
                    {/* Hover overlay */}
                    <div
                    ...
                    {/* Bottom metric */}
                    <div className="absolute bottom-0 left-0 right-0 px-5 py-3" style={{ background: 'rgba(129,41,33,0.8)', backdropFilter: 'blur(4px)' }}>
                      <div className="flex items-center gap-3">
    ...
    <div>
      <div className="overflow-hidden">
        ...
        <div className="relative h-[28vh] min-h-[220px] overflow-hidden">
          ...
          />
          <div className="absolute inset-0" style={{
            background: 'linear-gradient(180deg, rgba(129,41,33,0.5) 0%, rgba(129,41,33,0.9) 100%)'
          }} />
          <div className="absolute inset-0 flex flex-col justify-end px-6 md:px-12 lg:px-20 pb-10">
            <div className="max-w-7xl mx-auto w-full">
              <div className="flex items-center gap-3 mb-4">
