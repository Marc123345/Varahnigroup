...
import { VharananiTextScramble } from './TextScramble';
...
export function VharananiHomeBanner({
  ...
  return (
    <section className="relative w-full overflow-hidden" style={{ height: '100vh', minHeight: '640px' }}>
        ...
        <div className="grid grid-cols-12 gap-4 sm:gap-6 lg:gap-8 items-center">
          <div className="col-span-12 lg:col-span-8 xl:col-span-7 pt-20 sm:pt-24 lg:pt-28 pb-8">
            ...
            >
              ...
              <span className="typo-caption tracking-[0.3em] uppercase" style={{ color: 'var(--vharanani-burgundy)' }}>
            ...
            >
              {[
                ...
                >
                  ...
                  <div className="font-inter typo-meta tracking-[0.15em] uppercase" style={{ color: 'rgba(255,255,255,0.5)' }}>
                    {stat.label}
                  </div>
                </div>
              ))}
      ...
      >
        <span className="font-inter typo-meta tracking-[0.2em] uppercase" style={{ color: 'rgba(255,255,255,0.4)' }}>
          SCROLL
        </span>
        <div className="w-[1px] h-6" style={{ background: 'rgba(255,255,255,0.2)' }} />
          ...
          <div className="animate-ticker-left flex whitespace-nowrap py-[6px]">
            {[...TICKER_ROW_1, ...TICKER_ROW_1].map((item, i) => (
              <span key={`t1-${i}`} className="flex items-center gap-5 px-5 flex-shrink-0">
                <span className="font-inter typo-meta tracking-[0.25em] uppercase whitespace-nowrap" style={{ color: 'rgba(255,255,255,0.45)' }}>
                  {item}
                </span>
          ...
          <div className="animate-ticker-right flex whitespace-nowrap py-[6px]">
            {[...TICKER_ROW_2, ...TICKER_ROW_2].map((item, i) => (
              <span key={`t2-${i}`} className="flex items-center gap-5 px-5 flex-shrink-0">
                <span className="font-bebas-neue typo-label tracking-[0.15em] uppercase whitespace-nowrap" style={{ color: 'rgba(255,255,255,0.3)' }}>
                  {item}
                </span>
