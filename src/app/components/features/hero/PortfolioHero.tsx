...
import { CSS3DCube } from '../cube/CSS3DCube';
...
export function VharananiPortfolioHero() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-full h-full rotate-45" style={{ border: '2px solid var(--vharanani-burgundy)' }} />
      </motion.div>
      ...
      >
        <div className="w-full h-full rotate-12" style={{ border: '1px solid var(--vharanani-burgundy)' }} />
      </motion.div>
      ...
      <div className="relative h-full grid grid-cols-12 gap-8 px-8 py-12 lg:px-16 lg:py-16">
        ...
        <div className="col-span-12 lg:col-span-3 flex flex-col justify-between z-10">
          <div className="space-y-8">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              <div className="typo-caption tracking-[0.2em] mb-2 uppercase" style={{ color: 'var(--vharanani-charcoal-40)', fontFamily: 'var(--font-inter)' }}>
                PORTFOLIO
              </div>
              <h1 className="font-bebas-neue typo-headline-big tracking-tight" style={{ color: 'var(--vharanani-white)' }}>
                VHARANANI<br />PROPERTIES
              </h1>
              <div className="font-inter typo-copy mt-3" style={{ lineHeight: '1.7', color: 'var(--vharanani-charcoal)' }}>
                Real Estate Development Group
              </div>
            </motion.div>

            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="space-y-2 pb-6" style={{ borderBottom: `1px solid var(--vharanani-charcoal-60)` }}>
              <div className="flex items-center gap-3">
                <div className="typo-label tracking-[0.15em] uppercase" style={{ color: 'var(--vharanani-charcoal)' }}>Est. 2008</div>
                <div className="w-1 h-1 rounded-full" style={{ backgroundColor: 'var(--vharanani-burgundy)' }} />
                <div className="typo-label tracking-[0.15em] uppercase" style={{ color: 'var(--vharanani-charcoal)' }}>South Africa</div>
              </div>
              <div className="typo-label tracking-[0.1em] uppercase" style={{ color: 'var(--vharanani-charcoal)' }}>Vision. Structure. Impact.</div>
              <div className="typo-label tracking-[0.1em] uppercase" style={{ color: 'var(--vharanani-charcoal)' }}>Johannesburg, Gauteng</div>
            </motion.div>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1, delay: 1 }} className="hidden lg:flex items-center gap-3">
            <div className="w-px h-12" style={{ backgroundColor: 'var(--vharanani-burgundy)' }} />
            <div className="typo-meta tracking-[0.2em] uppercase rotate-90 origin-left" style={{ color: 'var(--vharanani-charcoal-40)' }}>
              SCROLL TO EXPLORE
            </div>
          </motion.div>
        </div>
        ...
        <div className="col-span-12 lg:col-span-6 flex items-center justify-center z-10">
          <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 1, delay: 0.3 }} className="relative w-full h-full max-w-2xl">
            <div className="absolute inset-0 pointer-events-none" style={{ border: `1px solid var(--vharanani-charcoal-60)` }}>
              ...
              <div className="absolute -top-6 left-0 flex items-center gap-2">
                <div className="typo-meta tracking-[0.2em] uppercase" style={{ color: 'var(--vharanani-burgundy)' }}>INTERACTIVE SHOWCASE</div>
              </div>
            ...
            <CSS3DCube images={cubeImages} activeIndex={activeProperty} />
          </motion.div>
        </div>

        {/* Right Column - Property Index */}
        <div className="col-span-12 lg:col-span-3 flex flex-col justify-center z-10">
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.5 }} className="space-y-1">
            <div className="typo-caption tracking-[0.2em] mb-6 uppercase pb-3" style={{ color: 'var(--vharanani-burgundy)', borderBottom: `1px solid var(--vharanani-charcoal-60)` }}>
            ...
            <div className="space-y-0">
              {properties.map((property, index) => (
                <motion.div
                  ...
                  style={{ borderColor: activeProperty === index ? 'var(--vharanani-burgundy)' : 'var(--vharanani-charcoal-60)' }}
                  whileHover={{ x: 8 }}
                >
                  <div className="flex items-center gap-3 mb-2">
                    <div className="font-bebas-neue text-lg transition-colors" style={{ color: activeProperty === index ? 'var(--vharanani-burgundy)' : 'var(--vharanani-charcoal-40)' }}>
                      {property.id}
                    </div>
                    <div className="w-px h-3" style={{ backgroundColor: activeProperty === index ? 'var(--vharanani-burgundy)' : 'var(--vharanani-charcoal-60)' }} />
                    <div className="typo-meta tracking-[0.2em] uppercase transition-colors" style={{ color: activeProperty === index ? 'var(--vharanani-burgundy)' : 'var(--vharanani-charcoal-60)' }}>
                      {property.type}
                    </div>
                  </div>
                  <h4 className="font-bebas-neue typo-headline-small mb-1 transition-colors" style={{ color: activeProperty === index ? 'var(--vharanani-white)' : 'var(--vharanani-charcoal-40)' }}>
                    {property.title}
                  </h4>
                  <div className="typo-meta tracking-[0.15em] uppercase transition-colors" style={{ color: activeProperty === index ? 'var(--vharanani-burgundy)' : 'var(--vharanani-charcoal-60)' }}>
                    {property.category}
                  </div>
                  {activeProperty === index && (
                    <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} exit={{ opacity: 0, height: 0 }} className="mt-2 font-inter typo-meta leading-relaxed" style={{ color: 'var(--vharanani-charcoal-40)' }}>
            ...
            <motion.div className="pt-6 flex items-center gap-2 group cursor-pointer" whileHover={{ x: 4 }}>
              <div className="typo-meta tracking-[0.2em] uppercase transition-colors" style={{ color: 'var(--vharanani-burgundy)' }}>VIEW ALL PROJECTS</div>
              <div className="w-8 h-px transition-all group-hover:w-12" style={{ backgroundColor: 'var(--vharanani-burgundy)' }} />
            </motion.div>
          </motion.div>
        </div>
      </div>
      ...
      {/* Accent Line - Bottom */}
      <div className="absolute bottom-0 left-0 right-0 h-px" style={{ backgroundColor: 'var(--vharanani-burgundy)' }} />
    </div>
  );
}
