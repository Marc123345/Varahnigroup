...
export function GlassmorphismOverlay({
  ...
  return (
    ...
    >
              ...
              {tabs.map((tab, i) => (
                ...
                >
                  <div className="flex items-center gap-3 mb-6">
                    <span className="font-bebas-neue text-lg" style={{ color: 'var(--vharanani-burgundy)' }}>
                      {String(i + 1).padStart(2, '0')}
                    </span>
                    <div className="flex-1 h-[1px]" style={{ backgroundColor: 'var(--vharanani-charcoal-20)' }} />
                    <span className="typo-caption tracking-[0.2em] uppercase font-inter" style={{ color: 'var(--vharanani-charcoal-40)' }}>
                      {tab.label}
                    </span>
                  </div>
                  {tab.content}
      ...
      {/* Bottom meta bar */}
      <div className="absolute bottom-1 left-0 right-0 flex items-center justify-between px-6 sm:px-10 lg:px-16 py-2 bg-white">
