...
const divisions: Division[] = [
  {
    ...
    image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/01_commercial_building_entrance_with_palm_trees.jpg?updatedAt=1774955145773',
    sections: [
      { id: 'about', index: 'Sec 1', title: 'Who We Are', type: 'INTELLIGENCE', description: 'Our story, mandate, and founding vision', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/61_corporate_boardroom_long_table_leather_chairs.jpg?updatedAt=1774955145578' },
      { id: 'portfolio', index: 'Sec 2', title: 'Our Portfolio', type: 'HOLDINGS', description: 'Subsidiary companies and sector expertise', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/23_aerial_view_industrial_warehouse_district.jpg?updatedAt=1774955148509' },
      { id: 'pillars', index: 'Sec 3', title: 'Strategic Pillars', type: 'STRATEGY', description: 'Infrastructure, assets, innovation, and social impact', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/17_aerial_view_highway_road_construction.jpg?updatedAt=1774955145967' },
      { id: 'leadership', index: 'Sec 4', title: 'Leadership', type: 'PEOPLE', description: 'Founder & Group Executive Chairman', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/10_municipal_council_chamber_boardroom.jpg?updatedAt=1774955148251' },
      { id: 'impact', index: 'Sec 5', title: 'Impact & Responsibility', type: 'IMPACT', description: 'Community benefit and social upliftment', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/82_colourful_social_housing_blocks_under_construction_township.jpg?updatedAt=1774955147460' },
      { id: 'vision-mission', index: 'Sec 6', title: 'Vision & Mission', type: 'MANDATE', description: 'Our vision, mission, and corporate overview', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/53_modern_government_office_building_brick_facade_dusk.jpg?updatedAt=1774955146060' },
      { id: 'governance', index: 'Sec 7', title: 'Governance & Compliance', type: 'COMPLIANCE', description: 'Ethics, risk management, and transparent reporting', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/05_ISO_9001_2015_certified_badge.jpg?updatedAt=1774955144716' },
      { id: 'companies', index: 'Sec 8', title: 'Our Companies', type: 'SUBSIDIARIES', description: 'Vharanani Properties, DMFT, David Mabilu Foundation', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/03_construction_site_drilling_equipment.jpg?updatedAt=1774955148273' },
      { id: 'sustainable-impact', index: 'Sec 9', title: 'Sustainable Impact & News', type: 'UPDATES', description: 'Driving impact, news, and contact information', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/84_aerial_view_brt_bus_rapid_transit_corridor_urban_road.jpg?updatedAt=1774955148424' },
    ],
  },
  {
    id: 'properties',
    ...
    image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/16_aerial_view_completed_road_rural_area.jpg?updatedAt=1774955145077',
    sections: [
      { id: 'about', index: 'Sec 1', title: 'About Us', type: 'INTELLIGENCE', description: 'Company history, leadership, and national reputation', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/24_modern_office_building_upward_angle_brick_facade.jpg?updatedAt=1774955146024' },
      { id: 'vision-values', index: 'Sec 2', title: 'Vision, Mission & Values', type: 'MANDATE', description: 'Our guiding principles and purpose', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/56_upward_angle_office_tower_brick_louvre_facade.jpg?updatedAt=1774955145324' },
      { id: 'roads-civils', index: 'Sec 3', title: 'Roads & Civil Engineering', type: 'SERVICES', description: 'Turnkey civil construction, BRT systems, highways', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/37_completed_curved_road_guardrail_mountain_backdrop.jpg?updatedAt=1774955145311' },
      { id: 'water-sanitation', index: 'Sec 4', title: 'Water & Sanitation', type: 'SERVICES', description: 'Bulk water supply, pipelines, sewer reticulation', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/04_large_diameter_pipeline_installation.jpg?updatedAt=1774955145168' },
      { id: 'building-construction', index: 'Sec 5', title: 'Building Construction', type: 'SERVICES', description: 'Public, commercial, and institutional building projects', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/12_commercial_building_under_construction.jpg?updatedAt=1774955144958' },
      { id: 'residential', index: 'Sec 6', title: 'Residential Development', type: 'SERVICES', description: 'RDP housing, apartments, townhouses, and estates', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/11_aerial_view_subsidised_housing_development.jpg?updatedAt=1774955145205' },
      { id: 'property-dev', index: 'Sec 7', title: 'Property Development', type: 'SERVICES', description: 'Turnkey development from land acquisition to construction', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/71_luxury_white_townhouses_glass_balustrades_balconies.jpg?updatedAt=1774955145169' },
      { id: 'accreditation', index: 'Sec 8', title: 'Accreditation & Compliance', type: 'COMPLIANCE', description: 'ISO 9001, B-BBEE Level 1, CIDB Grade 9', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/09_CIDB_construction_industry_development_board_logo.jpg?updatedAt=1774955145144' },
      { id: 'featured-projects', index: 'Sec 9', title: 'Featured Projects & Impact', type: 'PROJECTS', description: 'Major infrastructure projects and socioeconomic impact', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/59_civic_building_under_construction_workers_scaffolding.jpg?updatedAt=1774955145162' },
      { id: 'contact-footprint', index: 'Sec 10', title: 'Contact & Footprint', type: 'CONTACT', description: 'Office locations, enquiry form, and national reach', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/13_modern_office_tower_facade.jpg?updatedAt=1774955144811' },
    ],
  },
  {
    id: 'foundation',
    ...
    image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/48_aerial_view_colourful_social_housing_development.jpg?updatedAt=1774955145821',
    sections: [
      { id: 'about', index: 'Sec 1', title: 'About the Foundation', type: 'INTELLIGENCE', description: 'Our goal, approach, and founding vision', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/50_aerial_view_large_scale_subsidised_housing_estate.jpg?updatedAt=1774955146221' },
      { id: 'education', index: 'Sec 2', title: 'Education', type: 'PROGRAMMES', description: 'Scholarships, school support, and infrastructure', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/68_aerial_view_school_hospital_steel_roof_trusses_construction.jpg?updatedAt=1774955148374' },
      { id: 'housing', index: 'Sec 3', title: 'Housing', type: 'PROGRAMMES', description: 'Housing initiatives for disadvantaged families', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/52_aerial_view_completed_low_cost_housing_development.jpg?updatedAt=1774955147629' },
      { id: 'community', index: 'Sec 4', title: 'Community Upliftment', type: 'PROGRAMMES', description: 'Youth, women, sports, and community support', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/83_aerial_view_colourful_social_housing_blocks_township.jpg?updatedAt=1774955148467' },
      { id: 'impact', index: 'Sec 5', title: 'Our Impact', type: 'RESULTS', description: 'Meaningful contributions and lasting change', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/66_aerial_view_clinic_hospital_construction_red_roof.jpg?updatedAt=1774955145718' },
      { id: 'partnerships', index: 'Sec 6', title: 'Partnerships', type: 'NETWORK', description: 'Collaborative partnerships and the Vharanani Group', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/60_completed_civic_building_exterior_steel_louvres_staircase.jpg?updatedAt=1774955145732' },
      { id: 'heritage', index: 'Sec 7', title: 'Vharanani Group Heritage', type: 'HERITAGE', description: 'The backbone — supported by the Vharanani Group', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/81_civic_centre_building_water_storage_tanks_louvre_facade.jpg?updatedAt=1774955148440' },
      { id: 'get-involved', index: 'Sec 8', title: 'Contact & Get Involved', type: 'CONTACT', description: 'Join us in building opportunity', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/65_white_office_building_facade_parking_accessibility_ramp.jpg?updatedAt=1774955145537' },
    ],
  },
  {
    id: 'dmft',
    ...
    sections: [
      { id: 'about', index: 'Sec 1', title: 'About DMFT', type: 'INTELLIGENCE', description: 'Company overview and Vharanani Group partnership', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/26_residential_townhouse_terracotta_roof_garage.jpg?updatedAt=1774955146174' },
      { id: 'approach', index: 'Sec 2', title: 'Development Approach', type: 'PROCESS', description: 'Full lifecycle from land acquisition to delivery', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/14_aerial_view_bridge_construction_foundations.jpg?updatedAt=1774955148053' },
      { id: 'residential-estates', index: 'Sec 3', title: 'Residential Estates', type: 'DEVELOPMENTS', description: 'Secure estates for modern living', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/18_aerial_view_townhouse_complex_terracotta_roofs.jpg?updatedAt=1774955148592' },
      { id: 'apartments-townhouses', index: 'Sec 4', title: 'Apartments & Townhouses', type: 'DEVELOPMENTS', description: 'Urban apartments and modern townhouse complexes', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/72_aerial_view_brick_apartment_blocks_parking_area.jpg?updatedAt=1774955145408' },
      { id: 'mixed-use', index: 'Sec 5', title: 'Mixed-Use Developments', type: 'DEVELOPMENTS', description: 'Integrated residential, commercial, and community spaces', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/69_modern_brick_apartment_complex_street_view.jpg?updatedAt=1774955145953' },
      { id: 'capabilities', index: 'Sec 6', title: 'Capabilities & Quality', type: 'STANDARDS', description: 'Development expertise and quality commitment', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/02_aerial_view_residential_apartment_complex.jpg?updatedAt=1774955147816' },
      { id: 'heritage-contact', index: 'Sec 7', title: 'Heritage & Contact', type: 'CONTACT', description: 'Vharanani Group heritage and partnership enquiries', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/19_aerial_view_brick_apartment_complex_urban.jpg?updatedAt=1774955147753' },
    ],
  },
];

const extraCubeImages = [
  'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/33_aerial_view_transport_interchange_parking_construction.jpg?updatedAt=1774955145854',
  'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20final/27_aerial_view_completed_rural_road_with_bridge.jpg?updatedAt=1774955147812',
];
...
function getSectionContent(divisionId: string, sectionId: string, onTabChange?: (tabId: string) => void, onCrossNavigate?: (divId: string, secId?: string) => void): ReactNode {
  const contentMap: Record<string, Record<string, ReactNode>> = {
    properties: {
      ...
      'roads-civils': (<PropertiesWireframe_IntegratedServices activeService="roads-civils" />),
      'water-sanitation': (<PropertiesWireframe_IntegratedServices activeService="water-sanitation" />),
      'building-construction': (<PropertiesWireframe_IntegratedServices activeService="building-construction" />),
      residential: (<PropertiesWireframe_IntegratedServices activeService="residential" />),
      'property-dev': (<PropertiesWireframe_IntegratedServices activeService="property-dev" />),
