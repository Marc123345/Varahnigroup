...
const divisions: Division[] = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1509099836639-18ba1795216d?w=1080&q=80',
    sections: [
      { id: 'about', index: 'Sec 1', title: 'About the Foundation', type: 'INTELLIGENCE', description: 'Our goal, approach, and founding vision', image: 'https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?w=1080&q=80' },
      { id: 'education', index: 'Sec 2', title: 'Education', type: 'PROGRAMMES', description: 'Scholarships, school support, and infrastructure', image: 'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?w=1080&q=80' },
      { id: 'housing', index: 'Sec 3', title: 'Housing', type: 'PROGRAMMES', description: 'Housing initiatives for disadvantaged families', image: 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=1080&q=80' },
      { id: 'community', index: 'Sec 4', title: 'Community Upliftment', type: 'PROGRAMMES', description: 'Youth, women, sports, and community support', image: 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=1080&q=80' },
      { id: 'impact', index: 'Sec 5', title: 'Our Impact', type: 'RESULTS', description: 'Meaningful contributions and lasting change', image: 'https://images.unsplash.com/photo-1531206715517-5c0ba140b2b8?w=1080&q=80' },
      { id: 'partnerships', index: 'Sec 6', title: 'Partnerships', type: 'NETWORK', description: 'Collaborative partnerships and the Vharanani Group', image: 'https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?w=1080&q=80' },
      { id: 'heritage', index: 'Sec 7', title: 'Vharanani Group Heritage', type: 'HERITAGE', description: 'The backbone — supported by the Vharanani Group', image: 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=1080&q=80' },
      { id: 'get-involved', index: 'Sec 8', title: 'Contact & Get Involved', type: 'CONTACT', description: 'Join us in building opportunity', image: 'https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=1080&q=80' },
    ],
  },
  {
    id: 'dmft',
