...
const divisions: Division[] = [
  ...
  },
  {
    ...
    sections: [
      { id: 'about', index: 'Sec 1', title: 'About the Foundation', type: 'INTELLIGENCE', description: 'Our goal, approach, and founding vision', image: 'https://vharananiproperties.co.za/wp-content/uploads/2020/08/rsz_3-mogalakwena-4-1.jpg' },
      { id: 'education', index: 'Sec 2', title: 'Education', type: 'PROGRAMMES', description: 'Scholarships, school support, and infrastructure', image: 'https://vharananiproperties.co.za/wp-content/uploads/2020/08/Nellmapius.jpg' },
      { id: 'housing', index: 'Sec 3', title: 'Housing', type: 'PROGRAMMES', description: 'Housing initiatives for disadvantaged families', image: 'https://vharananiproperties.co.za/wp-content/uploads/2020/08/rsz_1-sterpark-residential.jpg' },
      { id: 'community', index: 'Sec 4', title: 'Community Upliftment', type: 'PROGRAMMES', description: 'Youth, women, sports, and community support', image: 'https://vharananiproperties.co.za/wp-content/uploads/2020/08/rsz_3-nellmapius-2-1.jpg' },
      { id: 'impact', index: 'Sec 5', title: 'Our Impact', type: 'RESULTS', description: 'Meaningful contributions and lasting change', image: 'https://vharananiproperties.co.za/wp-content/uploads/2020/08/Belle-Ombre-01.jpg' },
      { id: 'partnerships', index: 'Sec 6', title: 'Partnerships', type: 'NETWORK', description: 'Collaborative partnerships and the Vharanani Group', image: 'https://vharananiproperties.co.za/wp-content/uploads/2021/06/Transnet-8.jpg' },
      { id: 'heritage', index: 'Sec 7', title: 'Vharanani Group Heritage', type: 'HERITAGE', description: 'The backbone — supported by the Vharanani Group', image: 'https://vharananiproperties.co.za/wp-content/uploads/2021/06/Transnet-11.jpg' },
      { id: 'get-involved', index: 'Sec 8', title: 'Contact & Get Involved', type: 'CONTACT', description: 'Join us in building opportunity', image: 'https://vharananiproperties.co.za/wp-content/uploads/2020/08/rsz_dsc_0905b.jpg' },
    ],
  },
  {
    id: 'dmft',
