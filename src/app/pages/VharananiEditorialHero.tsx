...
const divisions: Division[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 'roads-civils', index: 'Sec 3', title: 'Roads & Civil Engineering', type: 'SERVICES', description: 'Turnkey civil construction, BRT systems, highways', image: 'https://ik.imagekit.io/qcvroy8xpd/Vharnani%20Group/Roads%20&%20Civil/Rectangle.png?tr=q-100:e-upscale' },
      { id: 'water-sanitation', index: 'Sec 4', title: 'Water & Sanitation', type: 'SERVICES', description: 'Bulk water supply, pipelines, sewer reticulation', image: 'https://vharananiproperties.co.za/wp-content/uploads/2021/06/Polokwane-CBD-Pipeline.png' },
      { id: 'building-construction', index: 'Sec 5', title: 'Building Construction', type: 'SERVICES', description: 'Public, commercial, and institutional building projects', image: 'https://vharananiproperties.co.za/wp-content/uploads/2020/08/rsz_5-nandoni-dam-1-1.jpg' },
      { id: 'residential', index: 'Sec 6', title: 'Residential Development', type: 'SERVICES', description: 'RDP housing, apartments, townhouses, and estates', image: 'https://vharananiproperties.co.za/wp-content/uploads/2021/06/SOSHANGUVE-EXT.19-RDP-HOUSES-1.jpg' },
      { id: 'property-dev', index: 'Sec 7', title: 'Property Development', type: 'SERVICES', description: 'Turnkey development from land acquisition to construction', image: 'https://vharananiproperties.co.za/wp-content/uploads/2020/08/rsz_dji_0519.jpg' },
      ...
      { id: 'featured-projects', index: 'Sec 9', title: 'Featured Projects & Impact', type: 'PROJECTS', description: 'Major infrastructure projects and socioeconomic impact', image: 'https://vharananiproperties.co.za/wp-content/uploads/2021/06/MAPHUTA-MALATJIE-HOSPITAL-2.jpg' },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 'housing', index: 'Sec 3', title: 'Housing', type: 'PROGRAMMES', description: 'Housing initiatives for disadvantaged families', image: 'https://vharananiproperties.co.za/wp-content/uploads/2021/06/SOSHANGUVE-EXT.19-RDP-HOUSES-1.jpg' },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 'residential-estates', index: 'Sec 3', title: 'Residential Estates', type: 'DEVELOPMENTS', description: 'Secure estates for modern living', image: 'https://vharananiproperties.co.za/wp-content/uploads/2020/10/Property-development-scaled.jpg' },
      ...
      { id: 'mixed-use', index: 'Sec 5', title: 'Mixed-Use Developments', type: 'DEVELOPMENTS', description: 'Integrated residential, commercial, and community spaces', image: 'https://vharananiproperties.co.za/wp-content/uploads/2020/10/Property-development-scaled.jpg' },
