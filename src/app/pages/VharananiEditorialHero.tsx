...
const divisions: Division[] = [
  ...
  },
  {
    ...
    sections: [
      { id: 'about', index: 'Sec 1', title: 'About the Foundation', type: 'INTELLIGENCE', description: 'Our goal, approach, and founding vision', image: 'https://ik.imagekit.io/qcvroy8xpd/DMF.png' },
      { id: 'education', index: 'Sec 2', title: 'Education', type: 'PROGRAMMES', description: 'Scholarships, school support, and infrastructure', image: 'https://ik.imagekit.io/qcvroy8xpd/DMF.png' },
      { id: 'housing', index: 'Sec 3', title: 'Housing', type: 'PROGRAMMES', description: 'Housing initiatives for disadvantaged families', image: 'https://ik.imagekit.io/qcvroy8xpd/DMF.png' },
      { id: 'community', index: 'Sec 4', title: 'Community Upliftment', type: 'PROGRAMMES', description: 'Youth, women, sports, and community support', image: 'https://ik.imagekit.io/qcvroy8xpd/DMF.png' },
      { id: 'impact', index: 'Sec 5', title: 'Our Impact', type: 'RESULTS', description: 'Meaningful contributions and lasting change', image: 'https://ik.imagekit.io/qcvroy8xpd/DMF.png' },
      { id: 'partnerships', index: 'Sec 6', title: 'Partnerships', type: 'NETWORK', description: 'Collaborative partnerships and the Vharanani Group', image: 'https://ik.imagekit.io/qcvroy8xpd/DMF.png' },
      { id: 'heritage', index: 'Sec 7', title: 'Vharanani Group Heritage', type: 'HERITAGE', description: 'The backbone — supported by the Vharanani Group', image: 'https://ik.imagekit.io/qcvroy8xpd/DMF.png' },
      { id: 'get-involved', index: 'Sec 8', title: 'Contact & Get Involved', type: 'CONTACT', description: 'Join us in building opportunity', image: 'https://ik.imagekit.io/qcvroy8xpd/DMF.png' },
    ],
  },
  {
    id: 'dmft',
