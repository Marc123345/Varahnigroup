...
const divisions: Division[] = [
  {
    ...
    image: 'https://vharananiproperties.co.za/wp-content/uploads/2021/06/hq.png',
    sections: [
      { id: 'about', index: 'Sec 1', title: 'Who We Are', type: 'INTELLIGENCE', description: 'Our story, mandate, and founding vision', image: 'https://vharananiproperties.co.za/wp-content/uploads/2020/08/faranani-1.jpg' },
      { id: 'portfolio', index: 'Sec 2', title: 'Our Portfolio', type: 'HOLDINGS', description: 'Subsidiary companies and sector expertise', image: 'https://vharananiproperties.co.za/wp-content/uploads/2020/08/Tswane-BRT.jpg' },
      { id: 'pillars', index: 'Sec 3', title: 'Strategic Pillars', type: 'STRATEGY', description: 'Infrastructure, assets, innovation, and social impact', image: 'https://vharananiproperties.co.za/wp-content/uploads/2021/06/Marulaneng-Road-2.jpg' },
      { id: 'leadership', index: 'Sec 4', title: 'Leadership', type: 'PEOPLE', description: 'Founder & Group Executive Chairman', image: 'https://vharananiproperties.co.za/wp-content/uploads/2020/09/DSC_0920B-1.jpg' },
      ...
      { id: 'vision-mission', index: 'Sec 6', title: 'Vision & Mission', type: 'MANDATE', description: 'Our vision, mission, and corporate overview', image: 'https://vharananiproperties.co.za/wp-content/uploads/2017/03/lepelle.jpg' },
      ...
      { id: 'companies', index: 'Sec 8', title: 'Our Companies', type: 'SUBSIDIARIES', description: 'Vharanani Properties, DMFT, David Mabilu Foundation', image: 'https://vharananiproperties.co.za/wp-content/uploads/2021/06/Polokwane-CBD-Pipeline.png' },
      { id: 'sustainable-impact', index: 'Sec 9', title: 'Sustainable Impact & News', type: 'UPDATES', description: 'Driving impact, news, and contact information', image: 'https://vharananiproperties.co.za/wp-content/uploads/2021/06/MAPHUTA-MALATJIE-HOSPITAL-2.jpg' },
    ],
  },
  {
    id: 'properties',
    ...
    sections: [
      { id: 'about', index: 'Sec 1', title: 'About Us', type: 'INTELLIGENCE', description: 'Company history, leadership, and national reputation', image: 'https://vharananiproperties.co.za/wp-content/uploads/2017/10/Building_Construction-27-1024x682.jpg' },
      { id: 'vision-values', index: 'Sec 2', title: 'Vision, Mission & Values', type: 'MANDATE', description: 'Our guiding principles and purpose', image: 'https://vharananiproperties.co.za/wp-content/uploads/2017/10/Building_Construction-24-1024x680.jpg' },
      { id: 'roads-civils', index: 'Sec 3', title: 'Roads & Civil Engineering', type: 'SERVICES', description: 'Turnkey civil construction, BRT systems, highways', image: 'https://vharananiproperties.co.za/wp-content/uploads/2021/07/H2-895x500.png' },
      ...
      { id: 'building-construction', index: 'Sec 5', title: 'Building Construction', type: 'SERVICES', description: 'Public, commercial, and institutional building projects', image: 'https://vharananiproperties.co.za/wp-content/uploads/2020/08/Capricon-FET.jpg' },
      { id: 'residential', index: 'Sec 6', title: 'Residential Development', type: 'SERVICES', description: 'RDP housing, apartments, townhouses, and estates', image: 'https://vharananiproperties.co.za/wp-content/uploads/2020/08/rsz_5-nandoni-dam-1-1.jpg' },
      ...
      { id: 'featured-projects', index: 'Sec 9', title: 'Featured Projects & Impact', type: 'PROJECTS', description: 'Major infrastructure projects and socioeconomic impact', image: 'https://vharananiproperties.co.za/wp-content/uploads/2017/10/Building_Construction-31-1024x683.jpg' },
      { id: 'contact-footprint', index: 'Sec 10', title: 'Contact & Footprint', type: 'CONTACT', description: 'Office locations, enquiry form, and national reach', image: 'https://vharananiproperties.co.za/wp-content/uploads/2020/08/st-maria.jpg' },
    ],
  },
  {
    id: 'foundation',
    ...
    sections: [
      { id: 'about', index: 'Sec 1', title: 'About the Foundation', type: 'INTELLIGENCE', description: 'Our goal, approach, and founding vision', image: 'https://ik.imagekit.io/qcvroy8xpd/A%20community%20health%20worker%20conducts%20a%20health%20education%20session%20outdoors%20in%20a%20rural%20village.png?updatedAt=1764674101441' },
      { id: 'education', index: 'Sec 2', title: 'Education', type: 'PROGRAMMES', description: 'Scholarships, school support, and infrastructure', image: 'https://ik.imagekit.io/qcvroy8xpd/A%20community%20health%20worker%20conducts%20a%20health%20education%20session%20outdoors%20in%20a%20rural%20village.png?updatedAt=1764674101441' },
      { id: 'housing', index: 'Sec 3', title: 'Housing', type: 'PROGRAMMES', description: 'Housing initiatives for disadvantaged families', image: 'https://ik.imagekit.io/qcvroy8xpd/A%20community%20health%20worker%20conducts%20a%20health%20education%20session%20outdoors%20in%20a%20rural%20village.png?updatedAt=1764674101441' },
      { id: 'community', index: 'Sec 4', title: 'Community Upliftment', type: 'PROGRAMMES', description: 'Youth, women, sports, and community support', image: 'https://ik.imagekit.io/qcvroy8xpd/A%20community%20health%20worker%20conducts%20a%20health%20education%20session%20outdoors%20in%20a%20rural%20village.png?updatedAt=1764674101441' },
      { id: 'impact', index: 'Sec 5', title: 'Our Impact', type: 'RESULTS', description: 'Meaningful contributions and lasting change', image: 'https://ik.imagekit.io/qcvroy8xpd/A%20community%20health%20worker%20conducts%20a%20health%20education%20session%20outdoors%20in%20a%20rural%20village.png?updatedAt=1764674101441' },
      { id: 'partnerships', index: 'Sec 6', title: 'Partnerships', type: 'NETWORK', description: 'Collaborative partnerships and the Vharanani Group', image: 'https://ik.imagekit.io/qcvroy8xpd/A%20community%20health%20worker%20conducts%20a%20health%20education%20session%20outdoors%20in%20a%20rural%20village.png?updatedAt=1764674101441' },
      { id: 'heritage', index: 'Sec 7', title: 'Vharanani Group Heritage', type: 'HERITAGE', description: 'The backbone — supported by the Vharanani Group', image: 'https://ik.imagekit.io/qcvroy8xpd/A%20community%20health%20worker%20conducts%20a%20health%20education%20session%20outdoors%20in%20a%20rural%20village.png?updatedAt=1764674101441' },
      { id: 'get-involved', index: 'Sec 8', title: 'Contact & Get Involved', type: 'CONTACT', description: 'Join us in building opportunity', image: 'https://ik.imagekit.io/qcvroy8xpd/A%20community%20health%20worker%20conducts%20a%20health%20education%20session%20outdoors%20in%20a%20rural%20village.png?updatedAt=1764674101441' },
    ],
  },
  {
    id: 'dmft',
    ...
    image: 'https://vharananiproperties.co.za/wp-content/uploads/2020/10/Property-development-scaled.jpg',
    sections: [
      { id: 'about', index: 'Sec 1', title: 'About DMFT', type: 'INTELLIGENCE', description: 'Company overview and Vharanani Group partnership', image: 'https://vharananiproperties.co.za/wp-content/uploads/2021/06/Facilities-1.jpg' },
      { id: 'approach', index: 'Sec 2', title: 'Development Approach', type: 'PROCESS', description: 'Full lifecycle from land acquisition to delivery', image: 'https://vharananiproperties.co.za/wp-content/uploads/2020/08/ISO-Certified-Construction-Company.png' },
      { id: 'residential-estates', index: 'Sec 3', title: 'Residential Estates', type: 'DEVELOPMENTS', description: 'Secure estates for modern living', image: 'https://vharananiproperties.co.za/wp-content/uploads/2020/08/rsz_1-the-mbilu-1.jpg' },
      { id: 'apartments-townhouses', index: 'Sec 4', title: 'Apartments & Townhouses', type: 'DEVELOPMENTS', description: 'Urban apartments and modern townhouse complexes', image: 'https://vharananiproperties.co.za/wp-content/uploads/2021/06/SOSHANGUVE-EXT.19-RDP-HOUSES-1.jpg' },
      { id: 'mixed-use', index: 'Sec 5', title: 'Mixed-Use Developments', type: 'DEVELOPMENTS', description: 'Integrated residential, commercial, and community spaces', image: 'https://vharananiproperties.co.za/wp-content/uploads/2020/08/rsz_2-anglo-platinum-1.jpg' },
      { id: 'capabilities', index: 'Sec 6', title: 'Capabilities & Quality', type: 'STANDARDS', description: 'Development expertise and quality commitment', image: 'https://vharananiproperties.co.za/wp-content/uploads/2018/08/Untitled-1.jpg' },
      { id: 'heritage-contact', index: 'Sec 7', title: 'Heritage & Contact', type: 'CONTACT', description: 'Vharanani Group heritage and partnership enquiries', image: 'https://vharananiproperties.co.za/wp-content/uploads/2020/08/rsz_dji_0519.jpg' },
    ],
  },
];
...
const extraCubeImages = [
  ...
  'https://vharananiproperties.co.za/wp-content/uploads/2017/03/maph.jpg',
];
