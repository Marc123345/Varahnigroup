...
const divisions: Division[] = [
  {
    ...
    sections: [
      ...
      { id: 'leadership', index: 'Sec 4', title: 'Leadership', type: 'PEOPLE', description: 'Founder & Group Executive Chairman', image: 'https://ik.imagekit.io/qcvroy8xpd/image%202.png' },
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1542810634-71277d95dcbb?w=1080&q=80',
    sections: [
      { id: 'about', index: 'Sec 1', title: 'About the Foundation', type: 'INTELLIGENCE', description: 'Our goal, approach, and founding vision', image: 'https://images.unsplash.com/photo-1509099836639-18ba1795216d?w=1080&q=80' },
      { id: 'education', index: 'Sec 2', title: 'Education', type: 'PROGRAMMES', description: 'Scholarships, school support, and infrastructure', image: 'https://images.unsplash.com/photo-1613899476277-76db78460235?w=1080&q=80' },
      { id: 'housing', index: 'Sec 3', title: 'Housing', type: 'PROGRAMMES', description: 'Housing initiatives for disadvantaged families', image: 'https://images.unsplash.com/photo-1594708767771-a7502209ff51?w=1080&q=80' },
      { id: 'community', index: 'Sec 4', title: 'Community Upliftment', type: 'PROGRAMMES', description: 'Youth, women, sports, and community support', image: 'https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?w=1080&q=80' },
      { id: 'impact', index: 'Sec 5', title: 'Our Impact', type: 'RESULTS', description: 'Meaningful contributions and lasting change', image: 'https://images.unsplash.com/photo-1541339907198-e08756dedf3f?w=1080&q=80' },
      { id: 'partnerships', index: 'Sec 6', title: 'Partnerships', type: 'NETWORK', description: 'Collaborative partnerships and the Vharanani Group', image: 'https://images.unsplash.com/photo-1577896851231-70ef18881754?w=1080&q=80' },
      { id: 'heritage', index: 'Sec 7', title: 'Vharanani Group Heritage', type: 'HERITAGE', description: 'The backbone — supported by the Vharanani Group', image: 'https://images.unsplash.com/photo-1526976668912-1a811878dd37?w=1080&q=80' },
      { id: 'get-involved', index: 'Sec 8', title: 'Contact & Get Involved', type: 'CONTACT', description: 'Join us in building opportunity', image: 'https://images.unsplash.com/photo-1469571486292-0ba58a3f068b?w=1080&q=80' },
    ],
  },
  {
    id: 'dmft',
